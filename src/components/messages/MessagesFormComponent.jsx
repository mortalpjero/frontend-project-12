  ...
  return (
    <Form novalidate="" className="py-1 border rounded-2" onSubmit={(e) => handleSendMessage(e)}>
      <Form.Group className="input-group has-validation">
        <Form.Control name="body" aria-label="Новое сообщение" placeholder="Введите сообщение..." className="border-0 p-0 ps-2 form-control" value={message} onChange={(e) => setMessage(e.target.value)} />
        <Button variant="outline-secondary" type="submit" disabled={message === ''} className="btn btn-group-vertical border-0">
